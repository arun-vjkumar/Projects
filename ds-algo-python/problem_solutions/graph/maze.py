...
from problem_solutions.graph.generic_search import Node, dfs, node_to_path, bfs, astar
...
class Maze:
    def __init__(self,
        ...
        self._grid: List[List[Cell]] = [[Cell.EMPTY for _ in range(self._columns)] for _ in range(self._rows)]
    ...
    def __str__(self) -> str:
        ...
        for row in self._grid:
            maze_in_str += "".join(c.value for c in row) + "\n"
        return maze_in_str
